...
urlpatterns = [
    ...
    path('dispositivosApi/', vistaApis.dispositivosApi,name='dispositivosApi'),
    path('dispositivosListApi/', vistaApis.dispositivo_listado,name='dispositivosListApi'),
    path('dispositivosListApi/<int:pk>', vistaApis.dispositivo_detalles,name='dispositivoDetalleApi'),
]
